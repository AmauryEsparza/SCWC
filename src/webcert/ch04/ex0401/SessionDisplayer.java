...
/**
 * Created by AmauryEsparza on 5/15/16.
 */
public class SessionDisplayer extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if(request.getParameter("getSession") != null && request.getParameter("getSession").equals("true")) {
            ...
            out.println("No getSessionParameter found");
        }
